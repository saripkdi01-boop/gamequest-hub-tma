...
export type GameQuestPlayer = { id: string; telegramUserId: number; username: string | null; firstName: string; lastName: string | null; languageCode: string | null; photoUrl: string | null; level: number; experience: number; questStreak: number; relics: number; questCoins: number; mindScore: number; dailyScore: number; energy: number; comboBest: number; preferredLanguage: LanguageCode; playerStatus: "new" | "active" | "inactive"; createdAt: string; updatedAt: string; lastSeenAt: string };
